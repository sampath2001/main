...
global svm_acc, random_acc, ann_acc
...
def runANN():
    ...
    text.insert(END,"Prediction Results\n\n") 
    prediction_data = prediction(X_test, cls) 
    ann_acc = cal_accuracy(y_test, prediction_data,'ANN Algorithm Accuracy, Classification Report & Confusion Matrix') 


def graph():
    height = [svm_acc,random_acc,ann_acc]
    bars = ('SVM Accuracy', 'Random Forest Accuracy','ANN Accuracy')
...
runeml = Button(main, text="Run ANN Algorithm", command=runANN)
